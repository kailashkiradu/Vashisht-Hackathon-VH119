...
public class imple implements  inter {
	...
	try{
		...
		ps.setString(7, rb.getCompanyname());
		ps.setString(8, "Requested");
		ps.setString(9, rb.getFilename());
		ps.setString(10, rb.getFiletype());
		ps.setString(11, rb.getFilesize());
		ps.setString(12, rb.getFilecontent());
		ps.setString(13, rb.getPhash());
		ps.setString(14, rb.getAhash());
		ps.setString(15, rb.getMail());
		u=ps.executeUpdate();
		}catch(Exception e)
		{
			e.printStackTrace();
